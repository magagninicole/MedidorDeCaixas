...
# 4 "D:\\MPLAB\\pic\\include\\c99\\stdlib.h" 2 3
...
# 10 "D:\\MPLAB\\pic\\include\\c99\\stdlib.h" 2 3
...
# 168 "D:\\MPLAB\\pic\\include\\c99\\bits/alltypes.h" 3
typedef __int24 int24_t;
# 204 "D:\\MPLAB\\pic\\include\\c99\\bits/alltypes.h" 3
...
# 4 "D:\\MPLAB\\pic\\include\\c99\\xc8debug.h" 2 3
...
{
  int24_t n = ( 16000000 / (16 * baud_rate) ) - 1;
...
void __attribute__((picinterrupt(("")))) isr(void){
    ...
    if(INTCONbits.INT0IF){
        ...
        if(medindo == 0 && PORTBbits.RB0 == 1){
            ...
            TMR1ON = 0;
            tempo_echo = (TMR1L | (TMR1H<<8))/110;
            valor_display = tempo_echo;


            if(flag_TARA == 0 && valor_tara > 0)
